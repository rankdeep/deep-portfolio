...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tags: ['WordPress', 'Gutenberg', 'Custom Code'],
    url: 'https://kasha.com.au',
    type: 'wordpress',
  },
  {
    img: '/julia-ai.webp',
    alt: 'Julia AI website homepage',
    category: 'WordPress · AI Assistant',
    title: 'Julia AI',
    excerpt: 'An AI assistant trained on your own website content. Answers prospective student questions instantly, in any language, and captures serious enquiries.',
    tags: ['WordPress', 'Elementor', 'Frontend'],
    url: 'https://juliaai.org',
    type: 'wordpress',
  },
   {
    img: '/caa.webp',
    alt: 'Childrens Author Alliance website homepage',
    category: 'WordPress · Membership . Author',
    title: 'Childrens Author Alliance',
    excerpt: 'A professional advocacy organization built for the authors who give children their stories.',
    tags: ['WordPress', 'Elementor', 'Custom Code'],
    url: 'https://childrensauthoralliance.org',
    type: 'wordpress',
  },
  {
    img: '/The-Jordan-Insurance-Agency-home.webp',
